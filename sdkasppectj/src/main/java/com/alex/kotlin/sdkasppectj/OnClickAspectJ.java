package com.alex.kotlin.sdkasppectj;
...
import com.alex.kotlin.sdk.DataStatisticsMake;
...
public class OnClickAspectJ {
     ...
     * @param joinPoint JoinPoint
     */
    @After("execution(@com.alex.kotlin.sdkasppectj.OnClickAnnotation * *(android.view.View))")
    ...
    public void onOptionsItemSelectedAOP(JoinPoint joinPoint) {
        ...
        DataStatisticsMake.trackViewOnClick(joinPoint.getTarget(), view);
    }
    ...
    public void onDialogClickAOP(final JoinPoint joinPoint) {
        ...
        DataStatisticsMake.trackViewOnClick(dialogInterface, which);
    }
    ...
    public void onDialogMultiChoiceClickAOP(final JoinPoint joinPoint) {
        ...
        DataStatisticsMake.trackViewOnClick(dialogInterface, which, isChecked);
    }
    ...
    public void onCheckedChangedAOP(final JoinPoint joinPoint) {
        ...
        DataStatisticsMake.trackViewOnClick(compoundButton, isChecked);
    }
    ...
    public void onItemSelectedAOP(final JoinPoint joinPoint) {
        ...
        DataStatisticsMake.trackViewOnClick(adapterView, view, position);
    }
    ...
    public void onTabChangedAOP(final JoinPoint joinPoint) {
        ...
        DataStatisticsMake.trackTabHost(tabName);
    }
    ...
    public void onExpandableListViewChildClickAOP(final JoinPoint joinPoint) {
        ...
        DataStatisticsMake.trackExpandableListViewChildOnClick(expandableListView, view, groupPosition, childPosition);
    }
    ...
    public void onExpandableListViewGroupClickAOP(final JoinPoint joinPoint) {
        ...
        View view = (View) joinPoint.getArgs()[1];
        int groupPosition = (int) joinPoint.getArgs()[2];
        DataStatisticsMake.trackExpandableListViewChildOnClick(expandableListView, view, groupPosition, -1);
    }
}
